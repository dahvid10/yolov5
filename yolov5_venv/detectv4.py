...
def run(
        ...
        connection_string='', # use connection string to create IoT client
        upload_images=False, # choose to upload to Azure
):
    source = str(source)
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        for i, det in enumerate(pred):  # per image
            ...
            # Upload results
            if upload_images:
                print("Uploading frame to Azure")
                connection_string = str(connection_string)
                img_uploader = Upload_to_Azure(connection_string)
                # save frame
                ...
                img_uploader.upload_img(filepath)
...
def parse_opt():
    ...
    parser.add_argument('--connection_string', type=str) # upload_to_azure
    parser.add_argument('--upload_images', action='store_true', help='upload images to Azure')
